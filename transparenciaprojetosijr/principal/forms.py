...
from wtforms import (StringField, RadioField, IntegerField, SubmitField, PasswordField, BooleanField, SelectField, DateField)
...
class EscolhaJornalForm(FlaskForm):
    jornal = RadioField("Jornal")
